...
//				return mapper
//						.readValue(decryptedString, wrapper.getClassType());
//			}
//		} catch (Exception exception) {
//			logger.error(
...
//			DocumentWrapper wrapper = new DocumentWrapper(key, ObjectJson,
//					value.getClass());
...
//				String encryptedString = mapper.writeValueAsString(entry
//						.getValue());
